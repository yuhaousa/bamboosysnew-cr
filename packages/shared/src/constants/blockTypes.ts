...
export const BLOCK_TYPES: BlockTypeMeta[] = [
  ...
  },
  {
    type: 'clients_grid',
    label: 'Clients Grid',
    description: 'Logo grid pulled from your clients content library',
    icon: 'layout-grid',
    category: 'social',
  },
  {
    type: 'partners_grid',
    label: 'Partners Grid',
    description: 'Partner logo grid pulled from your partners content library',
    icon: 'layout-grid',
    category: 'social',
  },
  {
    ...
    description: 'Modern solutions section powered by your solutions content library',
    icon: 'layout-grid',
    category: 'content',
  },
  {
    type: 'about_us_showcase',
    label: 'About Us Showcase',
    description: 'Modern about us section powered by your about us content library',
    icon: 'info',
    category: 'content',
  },
  {
