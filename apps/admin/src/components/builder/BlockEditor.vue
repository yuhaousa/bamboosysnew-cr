...
const editorMap: Record<string, ReturnType<typeof defineAsyncComponent>> = {
  ...
  clients_grid: defineAsyncComponent(() => import('./block-editors/ClientsGridEditor.vue')),
  partners_grid: defineAsyncComponent(() => import('./block-editors/PartnersGridEditor.vue')),
  solutions_showcase: defineAsyncComponent(() => import('./block-editors/SolutionsShowcaseEditor.vue')),
  about_us_showcase: defineAsyncComponent(() => import('./block-editors/AboutUsShowcaseEditor.vue')),
